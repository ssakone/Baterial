...
function(__qt_generate_qmldir VAR)
  ...
  set(OUT_FILENAME ${ARGGEN_OUTPUT_DIR}/qmldir)
...
# - OUTPUT_DIR: folder where to generate the qmldir file,
#               if left empty, it will be the same as SOURCE_DIR
...
function(qt_generate_qmldir VAR)
  ...
  foreach(DIR ${RECURSE_FILES})
    if(IS_DIRECTORY "${DIR}")
      ...
      if(ARGGEN_OUTPUT_DIR)
        set(OUTPUT_DIR "OUTPUT_DIR" "${ARGGEN_OUTPUT_DIR}")
      else()
        set(OUTPUT_DIR "OUTPUT_DIR" "${DIR}")
      endif()
      if(ARGGEN_MODULE)
